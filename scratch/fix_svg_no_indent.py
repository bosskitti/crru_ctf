...
# Rebuilding the HTML/SVG with absolutely NO leading spaces and NO blank lines.
...
with app.app_context():
    ...
    if l:
        try:
            ...
            # Find the enclosing container of our SVG block
            ...
            if target_start != -1 and target_end != -1:
                # Replace with the cleaned SVG block
                ...
                print("Successfully updated SVG diagram without any indentation or blank lines!")
            else:
