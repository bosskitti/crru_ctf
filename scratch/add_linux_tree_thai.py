...
# The HTML replacement code with Thai-first descriptions (completely flat, 0-indentation)
html_tree_thai = """<style>
...
<div class="tree-side-text-content">ระบบ Linux จัดเก็บและจัดระเบียบไฟล์ต่าง ๆ ในรูปแบบ <span class="highlight">โครงสร้างต้นไม้ (Hierarchy Tree)</span></div>
</div>
<div class="tl-scroll-hint" style="margin-top: 15px;"><i class="fas fa-arrows-alt-h"></i> <span>เลื่อนในแนวนอนเพื่อดูโครงสร้างแผนผังทั้งหมด</span></div>
<div class="flex-tree-scroll">
<div class="flex-tree-chart">
<div class="ft-root-box">
<div class="ft-card type-root" onmouseover="updateTreeDesc('/', 'ไดเรกทอรีราก (Root) - จุดเริ่มต้นและรากของระบบไฟล์ทั้งหมดใน Linux', '#fbbf24')" onmouseout="resetTreeDesc()">/ (root)</div>
<div class="line-v"></div>
</div>
<div class="ft-main-trunk"></div>
<div class="ft-grid">
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/bin/', 'โฟลเดอร์ไบนารี (Binary) - แหล่งเก็บไฟล์คำสั่งและโปรแกรมพื้นฐานที่จำเป็นสำหรับผู้ใช้ทุกคน', '#00c0ff')" onmouseout="resetTreeDesc()">/bin/</div>
</div>
<div class="ft-col type-bottom">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/opt/', 'ซอฟต์แวร์เสริม (Optional) - เก็บโปรแกรมและแอปพลิเคชันเสริมจากผู้ผลิตภายนอก', '#00c0ff')" onmouseout="resetTreeDesc()">/opt/</div>
</div>
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/boot/', 'โฟลเดอร์สำหรับบูต (Boot) - เก็บไฟล์ระบบปฏิบัติการที่จำเป็นในการเริ่มต้นเปิดเครื่อง เช่น Kernel และ GRUB', '#00c0ff')" onmouseout="resetTreeDesc()">/boot/</div>
</div>
<div class="ft-col type-bottom">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/root/', 'โฟลเดอร์ส่วนตัวของรูท (Root User Home) - พื้นที่เก็บข้อมูลส่วนตัวของสิทธิ์ผู้ดูแลระบบหลัก', '#00c0ff')" onmouseout="resetTreeDesc()">/root/</div>
</div>
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/dev/', 'โฟลเดอร์อุปกรณ์ (Devices) - แหล่งเก็บไฟล์ที่เชื่อมโยงกับฮาร์ดแวร์และอุปกรณ์เชื่อมต่อทั้งหมดในระบบ', '#00c0ff')" onmouseout="resetTreeDesc()">/dev/</div>
</div>
<div class="ft-col type-bottom">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/sbin/', 'โปรแกรมระบบ (System Binaries) - เก็บไฟล์คำสั่งระบบที่จำเป็นเฉพาะของผู้ดูแลระบบคอมพิวเตอร์', '#00c0ff')" onmouseout="resetTreeDesc()">/sbin/</div>
</div>
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/etc/', 'โฟลเดอร์ตั้งค่าระบบ (Etcetera) - แหล่งรวมไฟล์กำหนดค่าและคอนฟิกูเรชันของระบบทั้งหมด', '#00c0ff')" onmouseout="resetTreeDesc()">/etc/</div>
</div>
<div class="ft-col type-bottom">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/srv/', 'ข้อมูลการให้บริการ (Services) - เก็บไฟล์และข้อมูลที่ใช้ในการให้บริการเครือข่าย เช่น ข้อมูลเว็บไซต์', '#00c0ff')" onmouseout="resetTreeDesc()">/srv/</div>
</div>
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/home/', 'โฟลเดอร์บ้านผู้ใช้งาน (Home) - แหล่งเก็บข้อมูลส่วนตัวของผู้ใช้งานทั่วไปในระบบ', '#00c0ff')" onmouseout="resetTreeDesc()">/home/</div>
</div>
<div class="ft-col type-bottom">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/tmp/', 'ไฟล์ชั่วคราว (Temporary) - แหล่งเก็บไฟล์ใช้งานชั่วคราว ซึ่งจะถูกล้างออกเมื่อระบบรีสตาร์ท', '#00c0ff')" onmouseout="resetTreeDesc()">/tmp/</div>
</div>
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/lib/', 'ไฟล์ไลบรารีระบบ (Libraries) - แหล่งเก็บโมดูลระบบและไลบรารีที่จำเป็นในการรันโปรแกรมหลัก', '#00c0ff')" onmouseout="resetTreeDesc()">/lib/</div>
</div>
<div class="ft-col type-bottom has-subtree">
<div class="ft-card type-purple" onmouseover="updateTreeDesc('/usr/', 'โฟลเดอร์ผู้ใช้งาน (User) - เก็บโปรแกรมและไลบรารีขนาดใหญ่สำหรับผู้ใช้ทั่วไป (อ่านได้เฉพาะตัว)', '#ab20fd')" onmouseout="resetTreeDesc()">/usr/</div>
<div class="ft-sub-wrapper">
<div class="ft-sub-row">
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/usr/bin/', 'คำสั่งโปรแกรมทั่วไปสำหรับผู้ใช้งานในระบบ (User Executables)', '#3ddc84')" onmouseout="resetTreeDesc()">/bin/</div></div>
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/usr/include/', 'ไฟล์ส่วนหัวภาษา C/C++ (Header Files) สำหรับใช้พัฒนาซอฟต์แวร์', '#3ddc84')" onmouseout="resetTreeDesc()">/include/</div></div>
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/usr/lib/', 'ไฟล์ไลบรารีระบบทั่วไปสำหรับการทำงานของโปรแกรมต่างๆ', '#3ddc84')" onmouseout="resetTreeDesc()">/lib/</div></div>
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/usr/sbin/', 'คำสั่งควบคุมระบบเพิ่มเติมสำหรับผู้ดูแลระบบระดับสูง', '#3ddc84')" onmouseout="resetTreeDesc()">/sbin/</div></div>
</div>
</div>
</div>
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/media/', 'จุดเชื่อมอุปกรณ์พกพา (Media) - โโฟลเดอร์เมาท์สำหรับอุปกรณ์จัดเก็บข้อมูลแบบถอดเสียบ เช่น Flash Drive', '#00c0ff')" onmouseout="resetTreeDesc()">/media/</div>
</div>
<div class="ft-col type-bottom has-subtree">
<div class="ft-card type-purple" onmouseover="updateTreeDesc('/var/', 'โฟลเดอร์เก็บข้อมูลผันแปร (Variable) - แหล่งเก็บข้อมูลที่มีการเปลี่ยนแปลงบ่อย เช่น ล็อกไฟล์ ล็อกการระบบ', '#ab20fd')" onmouseout="resetTreeDesc()">/var/</div>
<div class="ft-sub-wrapper">
<div class="ft-sub-row">
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/var/cache/', 'พื้นที่เก็บข้อมูลแคชสำหรับแอปพลิเคชันต่างๆ เพื่อให้ระบบเรียกใช้ได้เร็วขึ้น', '#3ddc84')" onmouseout="resetTreeDesc()">/cache/</div></div>
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/var/log/', 'ล็อกไฟล์สำหรับบันทึกการทำงานและประวัติเหตุการณ์ต่างๆ ในระบบ', '#3ddc84')" onmouseout="resetTreeDesc()">/log/</div></div>
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/var/spool/', 'พื้นที่คิวพักข้อมูลชั่วคราว เช่น คิวพิมพ์เอกสาร หรืออีเมลพักส่ง', '#3ddc84')" onmouseout="resetTreeDesc()">/spool/</div></div>
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/var/tmp/', 'พื้นที่เก็บไฟล์ชั่วคราวที่จะไม่ถูกลบออกไปแม้เครื่องจะปิดรีบูตใหม่', '#3ddc84')" onmouseout="resetTreeDesc()">/tmp/</div></div>
</div>
</div>
</div>
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/mnt/', 'จุดเชื่อมระบบไฟล์อื่น (Mount) - ใช้สำหรับเมาท์และเข้าถึงระบบไฟล์ภายนอกเป็นการชั่วคราว', '#00c0ff')" onmouseout="resetTreeDesc()">/mnt/</div>
</div>
</div>
</div>
</div>
...
db.session.commit()
print("Linux Directory Tree updated with Thai-first description text successfully!")
