...
# ─── Replace Block 3 with glowing Gradient Color Bars for Section Headers ───
...
.w-comp-tbl th{padding:16px 18px;text-align:left;font-size:0.82rem;text-transform:uppercase;letter-spacing:0.08em;font-weight:700;border-bottom:2px solid rgba(255,255,255,0.15);}
...
/* ─── Glowing Gradient Color Bars for Section Headers ─── */
.w-comp-tbl tr.sec-hdr td{background:linear-gradient(90deg, rgba(0,240,255,0.15) 0%, rgba(255,0,127,0.15) 100%) !important;font-weight:800;font-size:0.92rem;color:#ffffff;border-top:1.5px solid rgba(255,255,255,0.12);border-bottom:1.5px solid rgba(255,255,255,0.12);padding:13px 18px;text-transform:uppercase;letter-spacing:0.05em;text-shadow:0 0 8px rgba(255,255,255,0.45);}
</style>
...
db.session.commit()
print("Linux vs Windows Master Comparison Table section headers updated with Gradient Color Bars!")
