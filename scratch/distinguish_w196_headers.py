...
# ─── Replace Block 3 with heavily distinguished section header rows ───
...
.w-comp-tbl th{padding:16px 18px;text-align:left;font-size:0.82rem;text-transform:uppercase;letter-spacing:0.08em;font-weight:700;border-bottom:2px solid rgba(255,255,255,0.1);}
...
/* ─── Highly Distinguished Section Header Rows ─── */
.w-comp-tbl tr.sec-hdr td{background:rgba(7,9,16,0.95) !important;font-weight:800;font-size:0.92rem;color:#fbbf24;border-top:1px solid rgba(255,255,255,0.08);border-bottom:2px solid #fbbf24;padding:12px 18px;text-transform:uppercase;letter-spacing:0.04em;text-shadow:0 0 6px rgba(251,191,36,0.25);}
</style>
...
db.session.commit()
print("Linux vs Windows Master Comparison Table section headers redesigned successfully!")
