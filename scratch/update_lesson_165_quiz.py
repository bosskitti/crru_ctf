...
with app.app_context():
    ...
    if lesson:
        ...
        # Prepare Block 20 containing 4 questions and 4 options, clean JS script
        blocks[20]['value'] = (
            "---\n"
            ...
            "        <div class=\"mini-opts\">\n"
            "          <div class=\"mini-opt\" data-val=\"A\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">A</span>/bin (Binary)</div>\n"
            "          <div class=\"mini-opt\" data-val=\"B\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">B</span>/etc (Etcetera)</div>\n"
            "          <div class=\"mini-opt\" data-val=\"C\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">C</span>/var (Variable data)</div>\n"
            "          <div class=\"mini-opt\" data-val=\"D\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">D</span>/dev (Devices)</div>\n"
            "        </div>\n"
            "      </div>\n\n"
            "      <!-- Question 2 -->\n"
            ...
            "        <div class=\"mini-opts\">\n"
            "          <div class=\"mini-opt\" data-val=\"A\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">A</span>เป็นไฟล์ชั่วคราวจัดเก็บอยู่ใน /tmp</div>\n"
            "          <div class=\"mini-opt\" data-val=\"B\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">B</span>เป็นโฟลเดอร์ส่วนบุคคลใน /home</div>\n"
            "          <div class=\"mini-opt\" data-val=\"C\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">C</span>เป็นไฟล์ประเภทอุปกรณ์ (Device Files) อยู่ใน /dev</div>\n"
            "          <div class=\"mini-opt\" data-val=\"D\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">D</span>เป็นไฟล์ไลบรารีฟังก์ชันระบบอยู่ใน /lib</div>\n"
            "        </div>\n"
            "      </div>\n\n"
            "      <!-- Question 3 -->\n"
            ...
            "        <div class=\"mini-opts\">\n"
            "          <div class=\"mini-opt\" data-val=\"A\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">A</span>Shell ทำหน้าที่รับและแปลคำสั่งภาษาคนส่งต่อให้ Kernel ซึ่งคอยควบคุมจัดแจงทรัพยากรฮาร์ดแวร์ของคอมพิวเตอร์</div>\n"
            "          <div class=\"mini-opt\" data-val=\"B\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">B</span>Shell ทำหน้าที่จัดคิวประมวลผลซีพียู ส่วน Kernel คอยแปลคำสั่งและแสดงผลหน้าเว็บเบราว์เซอร์</div>\n"
            "          <div class=\"mini-opt\" data-val=\"C\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">C</span>Shell เป็นอุปกรณ์กายภาพตัวเครื่องคอมพิวเตอร์ ส่วน Kernel เป็นแอปพลิเคชันเกมหรือเบราว์เซอร์ทั่วไป</div>\n"
            "          <div class=\"mini-opt\" data-val=\"D\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">D</span>ทั้ง Shell และ Kernel ทำงานร่วมกันเฉพาะส่วนของการเมาท์ไฟล์ภายนอกในไดเรกทอรี /mnt เท่านั้น</div>\n"
            "        </div>\n"
            "      </div>\n\n"
            "      <!-- Question 4 -->\n"
            ...
            "        <div class=\"mini-opts\">\n"
            "          <div class=\"mini-opt\" data-val=\"A\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">A</span>ช่วยให้ผู้ใช้งานภายนอกสามารถล็อกอินเข้าระบบผ่านหน้าจอ Terminal โดยใช้สิทธิ์ผู้ดูแลระบบสูงสุดได้ทันที</div>\n"
            "          <div class=\"mini-opt\" data-val=\"B\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">B</span>ช่วยเก็บประวัติและล็อกไฟล์ย้อนหลังทั้งหมดของกิจกรรมฝั่งเดสก์ท็อปผู้ใช้ที่อยู่ใน .history</div>\n"
            "          <div class=\"mini-opt\" data-val=\"C\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">C</span>ช่วยให้การเขียนโปรแกรมด้วยไฟล์ส่วนหัวภาษา C (.h) ในโฟลเดอร์ /usr/include ทำงานได้รวดเร็วขึ้น</div>\n"
            "          <div class=\"mini-opt\" data-val=\"D\" onclick=\"updateMiniProgress(2)\"><span class=\"mini-bullet\">D</span>ช่วยจำกัดเขตความเสียหาย หากบริการโดนแฮกเกอร์โจมตีเข้ามาได้ จะติดสิทธิ์เฉพาะบัญชีบอทนั้นๆ ไม่สามารถขยายสิทธิ์ไปยึดครองระดับ Root User ได้</div>\n"
            "        </div>\n"
            "      </div>\n\n"
        ...
        db.session.commit()
        print("Lesson 165 Quiz (Block 20) expanded and updated successfully!")
    else:
