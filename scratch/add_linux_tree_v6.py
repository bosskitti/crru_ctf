...
# The HTML replacement code for the exact staggered horizontal tree (completely flat, 0-indentation)
html_tree_v6 = """<style>
...
<div class="ft-card type-root" onmouseover="updateTreeDesc('/', 'Root directory - จุดเริ่มต้นและรากของระบบไฟล์ทั้งหมดใน Linux', '#fbbf24')" onmouseout="resetTreeDesc()">/ (root)</div>
<div class="line-v"></div>
</div>
<div class="ft-main-trunk"></div>
<div class="ft-grid">
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/bin/', 'Binary - ไดเรกทอรีเก็บคำสั่งโปรแกรมพื้นฐานที่จำเป็นต่อผู้ใช้งานทุกคน', '#00c0ff')" onmouseout="resetTreeDesc()">/bin/</div>
</div>
<div class="ft-col type-bottom">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/opt/', 'Optional - เก็บโปรแกรมซอฟต์แวร์เสริมและแอปพลิเคชันจากบุคคลที่สาม', '#00c0ff')" onmouseout="resetTreeDesc()">/opt/</div>
</div>
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/boot/', 'Boot - ไดเรกทอรีเก็บไฟล์ที่ใช้ในการบูตระบบปฏิบัติการ เช่น GRUB, Linux Kernel', '#00c0ff')" onmouseout="resetTreeDesc()">/boot/</div>
</div>
<div class="ft-col type-bottom">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/root/', 'Root user home - โฟลเดอร์ส่วนตัวของสิทธิ์ผู้ดูแลระบบหลัก (root)', '#00c0ff')" onmouseout="resetTreeDesc()">/root/</div>
</div>
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/dev/', 'Devices - แหล่งรวมไฟล์ตำแหน่งอุปกรณ์ต่างๆ ของระบบ เช่น ฮาร์ดดิสก์ ไดรฟ์ต่างๆ', '#00c0ff')" onmouseout="resetTreeDesc()">/dev/</div>
</div>
<div class="ft-col type-bottom">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/sbin/', 'System Binaries - เก็บโปรแกรมรันระบบที่สำคัญเฉพาะของสิทธิ์ผู้ดูแลระบบ (Admin)', '#00c0ff')" onmouseout="resetTreeDesc()">/sbin/</div>
</div>
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/etc/', 'Etcetera - แหล่งรวมไฟล์การกำหนดค่า (Configuration Files) ของระบบทั้งหมด', '#00c0ff')" onmouseout="resetTreeDesc()">/etc/</div>
</div>
<div class="ft-col type-bottom">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/srv/', 'Services - เก็บข้อมูลสำหรับการให้บริการต่างๆ บนเซิร์ฟเวอร์ เช่น FTP, Web server data', '#00c0ff')" onmouseout="resetTreeDesc()">/srv/</div>
</div>
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/home/', 'Home directory - โโฟลเดอร์บ้านของผู้ใช้ทั่วไป (Regular Users) ในระบบ', '#00c0ff')" onmouseout="resetTreeDesc()">/home/</div>
</div>
<div class="ft-col type-bottom">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/tmp/', 'Temporary - โโฟลเดอร์เก็บไฟล์ชั่วคราวที่จะล้างออกโดยอัตโนมัติเมื่อรีสตาร์ทเครื่อง', '#00c0ff')" onmouseout="resetTreeDesc()">/tmp/</div>
</div>
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/lib/', 'Libraries - แฟ้มรวมไลบรารีระบบและโมดูลเคอร์เนลที่จำเป็นในการบูต', '#00c0ff')" onmouseout="resetTreeDesc()">/lib/</div>
</div>
<div class="ft-col type-bottom has-subtree">
<div class="ft-card type-purple" onmouseover="updateTreeDesc('/usr/', 'User - เก็บโปรแกรมและไฟล์ไลบรารีขนาดใหญ่ที่ผู้ใช้ทั่วไปใช้งาน (เป็นโหมด Read-Only)', '#ab20fd')" onmouseout="resetTreeDesc()">/usr/</div>
<div class="ft-sub-wrapper">
<div class="ft-sub-row">
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/usr/bin/', 'คำสั่งการทำงานส่วนใหญ่ของผู้ใช้ทั่วไป (User Executables)', '#3ddc84')" onmouseout="resetTreeDesc()">/bin/</div></div>
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/usr/include/', 'ไฟล์ Header (.h) มาตรฐานสำหรับเขียนโปรแกรมภาษา C/C++', '#3ddc84')" onmouseout="resetTreeDesc()">/include/</div></div>
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/usr/lib/', 'ไฟล์ออบเจ็กต์และไลบรารีมาตรฐานสำหรับโปรแกรมต่างๆ', '#3ddc84')" onmouseout="resetTreeDesc()">/lib/</div></div>
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/usr/sbin/', 'คำสั่งควบคุมระบบที่เรียกใช้โดยผู้ดูแลระบบและแอปพลิเคชันระบบ', '#3ddc84')" onmouseout="resetTreeDesc()">/sbin/</div></div>
</div>
</div>
</div>
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/media/', 'Media - แหล่งเชื่อมต่ออุปกรณ์จัดเก็บข้อมูลแบบถอดเสียบได้ เช่น แฟลชไดรฟ์, แผ่น CD-ROM', '#00c0ff')" onmouseout="resetTreeDesc()">/media/</div>
</div>
<div class="ft-col type-bottom has-subtree">
<div class="ft-card type-purple" onmouseover="updateTreeDesc('/var/', 'Variable - แหล่งรวมข้อมูลที่มีการเปลี่ยนแปลงบ่อย เช่น ล็อกไฟล์ (Log files) และสปูลอีเมล', '#ab20fd')" onmouseout="resetTreeDesc()">/var/</div>
<div class="ft-sub-wrapper">
<div class="ft-sub-row">
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/var/cache/', 'พื้นที่เก็บข้อมูลแคชสำหรับแอปพลิเคชันต่างๆ', '#3ddc84')" onmouseout="resetTreeDesc()">/cache/</div></div>
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/var/log/', 'ล็อกไฟล์ของระบบที่บันทึกเหตุการณ์ต่างๆ ที่เกิดขึ้น (เช่น การพยายามเข้าระบบ)', '#3ddc84')" onmouseout="resetTreeDesc()">/log/</div></div>
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/var/spool/', 'พื้นที่พักข้อมูลชั่วคราวเพื่อรอส่งต่อ เช่น สปูลงานพิมพ์ (Printers) หรือเมลสปูล', '#3ddc84')" onmouseout="resetTreeDesc()">/spool/</div></div>
<div class="ft-sub-col"><div class="ft-card type-green" onmouseover="updateTreeDesc('/var/tmp/', 'โฟลเดอร์เก็บไฟล์ข้อมูลชั่วคราวที่จะไม่ล้างออกโดยอัตโนมัติเมื่อรีบูตระบบ', '#3ddc84')" onmouseout="resetTreeDesc()">/tmp/</div></div>
</div>
</div>
</div>
<div class="ft-col type-top">
<div class="ft-card type-blue" onmouseover="updateTreeDesc('/mnt/', 'Mount - โฟลเดอร์สำหรับเมาท์และเข้าถึงระบบไฟล์ชั่วคราวอื่นๆ', '#00c0ff')" onmouseout="resetTreeDesc()">/mnt/</div>
</div>
</div>
</div>
</div>
...
db.session.commit()
print("Linux Directory Tree restored to exact Staggered layout with scrollbar successfully!")
