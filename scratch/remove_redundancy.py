...
# 1. Clear redundant top-level directory tables (blocks 11 to 21)
for i in range(11, 22):
    blocks[i]['value'] = ""

# 2. Update Important Files tables (blocks 23 to 37) to bilingual format
bilingual_tables = {
...
db.session.commit()
print("Redundancy removed. Important files updated to bilingual format successfully!")
