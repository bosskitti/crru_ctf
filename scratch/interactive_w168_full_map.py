...
# ─── Replace Block 7 (System Architecture Layers) with FULL Interactive Architecture Map ───
...
/* Color Themes based on Functional Areas */
...
<div class="w-full-arch">
  ...
  <div class="w-arch-map">
    ...
    <div class="w-mode-sec kernel-mode">
      ...
      <!-- Row 3: Sub Managers and Drivers -->
      <div class="w-row">
        <!-- Sub I/O drivers -->
...
db.session.commit()
print("FULL Windows architecture map with all detailed sub-blocks updated successfully!")
