...
.neon-gauge-fill {{fill:none; stroke:url(#gauge-grad-{lesson_num}); stroke-width:2.8; stroke-linecap:round; transition:stroke-dasharray 0.5s ease; filter:drop-shadow(0 0 5px rgba(0,240,255,0.4));}}
...
<div class="mq-gauge-col">
  ...
  <div class="neon-gauge-container">
    <svg class="neon-gauge" viewBox="0 0 36 36">
      <defs>
        <linearGradient id="gauge-grad-{lesson_num}" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <path class="neon-gauge-fill" id="lesson-gauge-fill-{lesson_num}" stroke-dasharray="0, 100" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
      <text x="18" y="20.35" class="neon-gauge-text" id="lesson-gauge-text-{lesson_num}">0%</text>
    </svg>
  </div>
  <span id="lesson-status-txt-{lesson_num}" class="mt-3 d-block text-muted" style="font-size:0.78rem; text-align:center;">โปรดตอบคำถามให้ครบ 2 ข้อ</span>
</div>
</div>
</div>
